...
`
	...
	Describe("PrintCreateSequenceStatements", func() {
		...
		It("creates a basic sequence", func() {
			...
			structmatcher.ExpectStructsToMatchIncluding(&sequenceRel, &resultSequences[0].Relation, "Name", "Schema")
	...
	Describe("PrintAlterSequenceStatements", func() {
		It("creates a sequence owned by a table column", func() {
			...
			sequenceDef.OwningColumn = "public.sequence_table.a"

			sequenceDef.Definition = backup.SequenceDefinition{LastVal: 1, Increment: 1, MaxVal: math.MaxInt64, MinVal: 1, CacheVal: 1, StartVal: startValue}
			backup.PrintCreateSequenceStatements(backupfile, tocfile, []backup.Sequence{sequenceDef}, backup.MetadataMap{})
			backup.PrintAlterSequenceStatements(backupfile, tocfile, []backup.Sequence{sequenceDef})
