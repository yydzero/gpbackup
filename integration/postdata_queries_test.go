...
var _ = Describe("backup integration tests", func() {
	Describe("ConstructImplicitIndexNames", func() {
		It("returns an empty string if there are no implicit indexes", func() {
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE TABLE public.simple_table(i int)")
		...
		It("returns a string of all implicit indexes", func() {
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE TABLE public.simple_table(i int UNIQUE)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP TABLE public.simple_table")
	...
	Describe("GetIndex", func() {
		...
		It("returns a slice of multiple indexes", func() {
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE TABLE public.simple_table(i int, j int, k int)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP TABLE public.simple_table")
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE INDEX simple_table_idx1 ON public.simple_table(i)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP INDEX public.simple_table_idx1")
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE INDEX simple_table_idx2 ON public.simple_table(j)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP INDEX public.simple_table_idx2")

			index1 := backup.IndexDefinition{
				Oid: 0, Name: "simple_table_idx1", OwningSchema: "public", OwningTable: "simple_table", Def: "CREATE INDEX simple_table_idx1 ON public.simple_table USING btree (i)"}
			index2 := backup.IndexDefinition{
				Oid: 1, Name: "simple_table_idx2", OwningSchema: "public", OwningTable: "simple_table", Def: "CREATE INDEX simple_table_idx2 ON public.simple_table USING btree (j)"}
...
`)
			...
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE INDEX part_idx ON public.part(id)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP INDEX public.part_idx")
			index1 := backup.IndexDefinition{
				Oid: 0, Name: "part_idx", OwningSchema: "public", OwningTable: "part", Def: "CREATE INDEX part_idx ON public.part USING btree (id)"}
		...
		It("returns a slice for an index used for clustering", func() {
			...
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP INDEX public.simple_table_idx1")
			testhelper.AssertQueryRuns(connectionPool,
				"ALTER TABLE public.simple_table CLUSTER ON simple_table_idx1")

			index1 := backup.IndexDefinition{
				Oid: 0, Name: "simple_table_idx1", OwningSchema: "public", OwningTable: "simple_table", Def: "CREATE INDEX simple_table_idx1 ON public.simple_table USING btree (i)", IsClustered: true}
	...
	Describe("GetRules", func() {
		...
		BeforeEach(func() {
			...
			rule1 = backup.RuleDefinition{
				Oid: 0, Name: "double_insert", OwningSchema: "public", OwningTable: "rule_table1", Def: ruleDef1}
		})
		...
		It("returns a slice of multiple rules", func() {
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE TABLE public.rule_table1(i int)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP TABLE public.rule_table1")
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE TABLE public.rule_table2(i int)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP TABLE public.rule_table2")
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE RULE double_insert AS ON INSERT TO public.rule_table1 DO INSERT INTO public.rule_table1 (i) VALUES (1)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP RULE double_insert ON public.rule_table1")
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE RULE update_notify AS ON UPDATE TO public.rule_table1 DO NOTIFY rule_table1")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP RULE update_notify ON public.rule_table1")

			rule2 := backup.RuleDefinition{
				Oid: 1, Name: "update_notify", OwningSchema: "public", OwningTable: "rule_table1", Def: ruleDef2}
		...
		It("returns a slice of rules for a specific schema", func() {
			...
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE TABLE testschema.rule_table1(i int)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP TABLE testschema.rule_table1")
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE RULE double_insert AS ON INSERT TO testschema.rule_table1 DO INSERT INTO testschema.rule_table1 (i) VALUES (1)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP RULE double_insert ON testschema.rule_table1")
	...
	Describe("GetTriggers", func() {
		...
		It("returns a slice of multiple triggers", func() {
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE TABLE public.trigger_table1(i int)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP TABLE public.trigger_table1")
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE TABLE public.trigger_table2(j int)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP TABLE public.trigger_table2")
			testhelper.AssertQueryRuns(connectionPool,
				`CREATE TRIGGER sync_trigger_table1 AFTER INSERT OR DELETE OR UPDATE ON public.trigger_table1 FOR EACH STATEMENT EXECUTE PROCEDURE "RI_FKey_check_ins"()`)
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP TRIGGER sync_trigger_table1 ON public.trigger_table1")
			testhelper.AssertQueryRuns(connectionPool,
				`CREATE TRIGGER sync_trigger_table2 AFTER INSERT OR DELETE OR UPDATE ON public.trigger_table2 FOR EACH STATEMENT EXECUTE PROCEDURE "RI_FKey_check_ins"()`)
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP TRIGGER sync_trigger_table2 ON public.trigger_table2")

			trigger1 := backup.TriggerDefinition{
				Oid: 0,
				Name: "sync_trigger_table1",
				OwningSchema: "public",
				OwningTable: "trigger_table1",
				Def: `CREATE TRIGGER sync_trigger_table1 AFTER INSERT OR DELETE OR UPDATE ON public.trigger_table1 FOR EACH STATEMENT EXECUTE PROCEDURE "RI_FKey_check_ins"()`,
			}
			trigger2 := backup.TriggerDefinition{
				Oid: 1, Name: "sync_trigger_table2", OwningSchema: "public", OwningTable: "trigger_table2", Def: `CREATE TRIGGER sync_trigger_table2 AFTER INSERT OR DELETE OR UPDATE ON public.trigger_table2 FOR EACH STATEMENT EXECUTE PROCEDURE "RI_FKey_check_ins"()`}
		...
		It("does not include constraint triggers", func() {
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE TABLE public.trigger_table1(i int PRIMARY KEY)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP TABLE public.trigger_table1")
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE TABLE public.trigger_table2(j int)")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP TABLE public.trigger_table2")
			testhelper.AssertQueryRuns(connectionPool,
				"ALTER TABLE public.trigger_table2 ADD CONSTRAINT fkc FOREIGN KEY (j) REFERENCES public.trigger_table1 (i) ON UPDATE RESTRICT ON DELETE RESTRICT")
		...
		It("returns a slice of triggers for a specific schema", func() {
			...
			trigger1 := backup.TriggerDefinition{
				Oid: 0, Name: "sync_trigger_table1", OwningSchema: "testschema", OwningTable: "trigger_table1", Def: `CREATE TRIGGER sync_trigger_table1 AFTER INSERT OR DELETE OR UPDATE ON testschema.trigger_table1 FOR EACH STATEMENT EXECUTE PROCEDURE "RI_FKey_check_ins"()`}
...
AS $$ BEGIN RAISE EXCEPTION 'exception'; END; $$;`)
		...
		It("returns a slice of multiple event triggers ", func() {
			...
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE EVENT TRIGGER testeventtrigger1 ON ddl_command_start EXECUTE PROCEDURE abort_any_command();")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP EVENT TRIGGER testeventtrigger1")
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE EVENT TRIGGER testeventtrigger2 ON ddl_command_start EXECUTE PROCEDURE abort_any_command();")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP EVENT TRIGGER testeventtrigger2")

			results := backup.GetEventTriggers(connectionPool)
			eventTrigger1 := backup.EventTrigger{
				Oid: 1,
			...
			eventTrigger2 := backup.EventTrigger{
				Oid: 1,
				Name: "testeventtrigger2",
				Event: "ddl_command_start",
				FunctionName: "abort_any_command",
				Enabled: "O",
			}
		...
		It("returns a slice of event trigger with a filter tag", func() {
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE EVENT TRIGGER testeventtrigger1 ON ddl_command_start WHEN TAG IN ('DROP FUNCTION') EXECUTE PROCEDURE abort_any_command();")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP EVENT TRIGGER testeventtrigger1")
		...
		It("returns a slice of event trigger with multiple filter tags", func() {
			testhelper.AssertQueryRuns(connectionPool,
				"CREATE EVENT TRIGGER testeventtrigger1 ON ddl_command_start WHEN TAG IN ('DROP FUNCTION', 'DROP TABLE') EXECUTE PROCEDURE abort_any_command();")
			defer testhelper.AssertQueryRuns(connectionPool,
				"DROP EVENT TRIGGER testeventtrigger1")
